...
const Topbar = ({ counter, setCounter }) => {
  const handlerIncrement = () => {
    setCounter(counter < 9 ? counter + 1 : 0);
  };

  const handlerDecrement = () => {
    setCounter(counter > 0 ? counter - 1 : 9);
  };
      ...
      <div className="Topbar">
        <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
          <span className="slideLeft">
            <i className="icon-left-open" onClick={handlerDecrement} />
          </span>
          <span className="slideRight">
            <i className="icon-right-open" onClick={handlerIncrement} />
          </span>
          <div className="Spacex">
            <div className="troll">
              <svg className="svgClass" version="1.1" viewBox="-450 0 1200 50">
                <g>
                  <path
